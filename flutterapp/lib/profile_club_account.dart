            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildMiniStat('180', 'Total Members', Icons.people_rounded),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: _buildMiniStat('23', 'Posts', Icons.article_rounded),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
                      child: _buildMiniStat('12', 'Events', Icons.event_rounded),
                    ),
                  ],
                ),
              ],
